    ...
    return(
        ...
        <TabContext value={value}>
            <AppBar position="static">
                <Tabs centered indicatorColor="secondary" onChange={handleChange} style={{color:'rgb(209,49,224)', borderColor:'none', backgroundColor:"#fff"}} >
            ...
            <TabPanel value="2">
                <Typography variant="h5" gutterBottom color ="textPrimary" component="h5" align="center" className='titulo' style={{color:'rgb(209,49,224)', borderColor:'none', backgroundColor:"#fff", fontWeight:'bold'}}>
                    Sobre nós
                </Typography>

                <Typography variant="body1" gutterBottom color ="textPrimary" component="h5" align="justify" style={{color:'rgb(209,49,224)', borderColor:'none', backgroundColor:"#fff"}}>
